...
public class Activity_ViewToppings extends AppCompatActivity { //class to handle the events for the View Topping Activity
    ...
    protected void onCreate(Bundle savedInstanceState) { //Function to display the current activity and deserialize the control panel object passed from the last activity
        ...
        setContentView(R.layout.activity__view_toppings);
    ...
    private void populateList() { //Function to populate the list of toppings with values fetched from the database
        ListView listView = (ListView) findViewById(R.id.lstAllToppings);
        inventoryModelArrayList = controlPanel.getAllToppings();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(Activity_ViewToppings.this, Activity_EditTopping.class);
                intent.putExtra("topping", inventoryModelArrayList.get(position));
    ...
    public void onClickBtnAdd(View view) { //Event handler for the add button, starts the next activity
        Intent intent = new Intent(Activity_ViewToppings.this, Activity_AddTopping.class);
        intent.putExtra("controlPanel", controlPanel);
        startActivity(intent);
    }
